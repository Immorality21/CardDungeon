...
- **XP timing:** awarded to the leader (`Party.AddXpToLeader`) in memory during a dungeon; only committed to disk on dungeon clear (`Party.CommitProgress()`). Lost on death — see the Dungeon guide.
